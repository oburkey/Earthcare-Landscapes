    ...
    <div className="min-h-screen bg-bg">
      <div className="mx-auto max-w-2xl px-4 py-6 space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="h-9 w-24 rounded-lg bg-skeleton animate-pulse" />
        </div>
          ...
          {[0, 1, 2, 3].map((i) => (
            <div key={i} className="flex items-center gap-4 px-4 py-4">
              <div className="flex-1 space-y-1.5">
                ...
                <div className="h-3 w-52 rounded bg-skeleton animate-pulse" />
                <div className="flex items-center gap-3 mt-1">
                  <div className="h-3 w-16 rounded bg-skeleton animate-pulse" />
                  <div className="h-1.5 w-24 rounded-full bg-skeleton animate-pulse" />
                </div>
              </div>
